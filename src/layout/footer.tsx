export function Footer() {
  return (
    <footer
      className="absolute bottom-0 w-full z-10 bg-primary bg-opacity-5 pt-[100px] wow fadeInUp"
      data-wow-delay=".1s"
    >
      <div className="py-8 bg-primary bg-opacity-10">
        <div className="container">
          <p className="text-body-color dark:text-white text-base text-center">
            &copy; 2024 zoomdoggy.com
          </p>
        </div>
      </div>
